...
install_ptero() {
    ...
    bash <(curl -s https://raw.githubusercontent.com/lie-kg1/ptero/refs/heads/main/ptero/panel/pterodactyl/install.sh)
...
while true; do
    ...
    case $choice in
        ...
        2) create_user ;;
        3) update_panel ;;
        4) bash <(curl -fsSL https://raw.githubusercontent.com/lie-kg1/ptero/refs/heads/main/ptero/panel/pterodactyl/ssl.sh) ;;
        5) uninstall_ptero ;;
        6) clear; exit ;;
